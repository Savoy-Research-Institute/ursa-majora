...
//Objectives, read from battery via a voltage divider, calculate battery capacity from this values, 
//this file will run on the blizzard and the drone
//BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB
//objectives, eco modes, power modes, power management, 
...
{   //if device is blizzard 9v, if device is drone 12.6v
...
{   /*ask for battery capacity all the time, 
advice for lower power consumption,  


*/
    //from battery capacity measurement, do anaysis for max, balanced or ECO power modes, 
