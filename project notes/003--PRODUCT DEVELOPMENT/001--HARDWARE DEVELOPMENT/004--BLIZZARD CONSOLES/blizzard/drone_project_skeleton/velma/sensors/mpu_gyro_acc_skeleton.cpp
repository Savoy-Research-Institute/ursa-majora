...
/*switch mpu on and off, Read gyroscope and accelerometer,read from MPU registers, read mpu temperature, collect error from gyroscope drift, 
Decode the data? giving explicit functions, 
run MPU on ECO mode
change full scale sensitivity, 
run MPU self test, 
place at a certain memory place I can always go to fetch it...*/
//BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB
//flight stabilization algorithm will adopt features from this library
